...
my_int = my_int + 4
print(my_int)
print(my_int - 1) # Esto no cambia el valor de la variable, sino del valor que se va a mostrar en el print

my_float = 3.14
print(type(my_float))
print(my_float)

print(my_float + my_int) # Podemos operar con float e int de manera indistinta, Python se encarga de hacer la conversion de tipos

my_boole = False
print(type(my_boole))
print(my_boole)

print("El valor de mi entero es " + str(my_int) + " y el de mi bool es " + str(my_boole)) # Para concatenar cadenas de texto y otros tipos de datos, es necesario convertirlos a string

print(f"El valor de mi entero es {my_int} y el de mi bool es {my_boole}") # Otra forma de concatenar cadenas de texto y otros tipos de datos, es usando f-strings, que son una forma mas moderna y legible de hacerlo
...
my_dict = {"int: ": my_int, "float: ": my_float, "bool: ": my_boole} # Diccionarios en Python
print(type(my_dict))
print(my_dict)
...
if my_int == 11 or my_boole == True: # Estructura de control IF
